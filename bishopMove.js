...
public function select(){
	...
	for(m = 5; m < 40; m = m+5){
	moves_positive_z += Physics.RaycastAll(transform.position + new Vector3(m,0,m),new Vector3(0,-1,0), 10F);
	moves_negative_z += Physics.RaycastAll(transform.position + new Vector3(-m,0,m),new Vector3(0,-1,0), 10F);
	moves_positive_x += Physics.RaycastAll(transform.position + new Vector3(m,0,-m),new Vector3(0,-1,0), 10F);
	moves_negative_x += Physics.RaycastAll(transform.position + new Vector3(-m,0,-m),new Vector3(0,-1,0), 10F);
	}
